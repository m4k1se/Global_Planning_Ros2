...
def get_waypoint(node, waypoint, rgb = [0.0,0.0,0.0], lifetime = 0.2, scale = 0.2):
    """
    ...
    waypoint_marker.header.stamp = node.get_clock().now().to_msg()
    ...
    waypoint_marker.lifetime = rclpy.duration.Duration(seconds=lifetime).to_msg()
...
def get_waypoints(node, waypoint_list, rgb = [0.0,0.0,0.0], lifetime = 0.2, scale = 0.2):
    """
    ...
    waypoints_marker.header.stamp = node.get_clock().now().to_msg()
    ...
    waypoints_marker.lifetime = rclpy.duration.Duration(seconds=lifetime).to_msg()
...
def get_point(node, x, y, z, rgb = [0.0,0.0,0.0], lifetime = 0.2, scale = 0.2):
    """
    ...
    point_marker.header.stamp = node.get_clock().now().to_msg()
